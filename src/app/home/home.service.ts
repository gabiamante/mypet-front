...
export class PesquisarService {
  ...
  filtroHome(pessoa: PessoaJuridica): Observable<PessoaJuridica[]> {
    ...
    this.fornecedores = this.http.get<PessoaJuridica[]>(API + '/pessoajuridica/estadoAndCidadeAndBairroAndFornecedor/filtro?cidade=' + pessoa.cidade +
      '&estado=' + pessoa.estado + '&bairro=' + pessoa.bairro + '&razaoSocial=' + pessoa.razaoSocial);
